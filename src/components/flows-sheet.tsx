...
import { Zap, ChevronRight, Plus, ChevronUp } from 'lucide-react';
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild>
        <button className="fixed bottom-0 inset-x-0 z-30 bg-background border-t px-4 py-3 flex items-center justify-between">
